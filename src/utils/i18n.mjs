  ...
  const MESSAGES = {
    en: {
      ...
      themeSystem: 'System',
      uiShape: 'Component shape',
      uiShapeSquare: 'Square',
      uiShapeSubtle: 'Subtle',
      uiShapeRounded: 'Rounded',
      uiShapePill: 'Pill',
      uiShapeHint: 'Controls, cards, menus, and messages update immediately.',
      visualStyle: 'Visual style',
      visualStyleCurrent: 'Modern',
      visualStyleCurrentDescription: 'Calm, polished, and focused.',
      visualStyleCleanMinimal: 'Clean Minimal',
      visualStyleCleanMinimalDescription: 'Quiet, spacious, and focused.',
      visualStyleTerminal: 'Terminal',
      visualStyleTerminalDescription: 'Compact, precise, and command-line inspired.',
      visualStyleWarmEditorial: 'Warm Editorial',
      visualStyleWarmEditorialDescription: 'Warm tones with expressive typography.',
      visualStyleNeoBrutalist: 'Neo-brutalist',
      visualStyleNeoBrutalistDescription: 'Bold borders, strong contrast, and punchy color.',
      visualStyleApple: 'Glass Atelier',
      visualStyleAppleDescription: 'Soft depth, refined neutrals, and crisp blue accents.',
      visualStyleGoogle: 'Chromatic Canvas',
      visualStyleGoogleDescription: 'Friendly color, open spacing, and clear surfaces.',
      visualStyleMeta: 'Open Horizon',
      visualStyleMetaDescription: 'Bright blue, fluid depth, and social clarity.',
      visualStyleMicrosoft: 'Structured Mosaic',
      visualStyleMicrosoftDescription: 'Layered surfaces, practical density, and balanced color.',
      visualStyleSelected: 'Selected',
      memory: 'Memory',
      ...
      disabled: 'disabled',
      edit: 'Edit',
      a2aTokenUnchanged: 'Leave blank to keep current token',
      ...
      responseTimeoutMinutes: 'Minutes',
      responseTimeoutHint: 'Maximum total wait for an AI request. Streaming activity keeps the interface active, but the request still stops at this total limit.',
      ready: 'Ready',
      ...
      restorePanel: 'Restore OmniPilot',
    ...
    zh: {
      ...
      uiShapeRounded: '圆角',
      uiShapePill: '胶囊',
      uiShapeHint: '控件、卡片、菜单和消息会立即更新。',
      visualStyle: '视觉风格',
      visualStyleCurrent: '现代',
      visualStyleCurrentDescription: '沉静、精致且专注。',
      visualStyleCleanMinimal: '简洁极简',
      visualStyleCleanMinimalDescription: '安静、宽松且专注。',
      visualStyleTerminal: '终端',
      visualStyleTerminalDescription: '紧凑、精确，灵感来自命令行。',
      visualStyleWarmEditorial: '温暖编辑风',
      visualStyleWarmEditorialDescription: '温暖色调搭配富有表现力的排版。',
      visualStyleNeoBrutalist: '新粗野主义',
      visualStyleNeoBrutalistDescription: '醒目边框、强烈对比和鲜明色彩。',
      visualStyleApple: '玻璃工坊',
      visualStyleAppleDescription: '柔和层次、精致中性色与清晰蓝色点缀。',
      visualStyleGoogle: '绚彩画布',
      visualStyleGoogleDescription: '亲和色彩、舒展间距与清晰表面。',
      visualStyleMeta: '开阔地平线',
      visualStyleMetaDescription: '明亮蓝色、流动层次与社交化清晰感。',
      visualStyleMicrosoft: '秩序马赛克',
      visualStyleMicrosoftDescription: '分层表面、实用密度与均衡色彩。',
      visualStyleSelected: '已选择',
      memory: '记忆',
      ...
      responseTimeoutMinutes: '分钟',
      responseTimeoutHint: 'AI 请求的最长总等待时间。流式活动会保持界面活跃，但请求仍会在达到总时限时停止。',
      ready: '就绪',
