  ...
  const MESSAGES = {
    en: {
      ...
      visualStyleCurrent: 'Current',
      visualStyleCurrentDescription: 'The familiar OmniPilot look.',
    ...
    zh: {
      ...
      visualStyle: '视觉风格',
      visualStyleCurrent: '当前风格',
      visualStyleCurrentDescription: '熟悉的 OmniPilot 外观。',
